...
const FeaturedProjects = () => {
  ...
  return (
    <section
      id="projects"
      className=" min-h-screen flex flex-col items-center lg:gap-24 gap-12 pt-[100px] lg:pb-30 sm:pb-24 pb-16 lg:px-44 sm:px-28 px-4"
    >
      <motion.h1
        initial={{ y: 25, opacity: 0 }}
        whileInView={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.75 }}
        className="sm:text-5xl text-3xl text-center font-bold bg-gradient-to-r bg-clip-text text-transparent from-blue-600 to-blue-200"
      >
        FEATURED PROJECTS
      </motion.h1>
